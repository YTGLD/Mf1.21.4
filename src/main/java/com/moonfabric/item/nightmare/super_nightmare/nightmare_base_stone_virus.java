...
public class nightmare_base_stone_virus extends com.moonfabric.item.Ms.SNightmare{
    ...
    public nightmare_base_stone_virus(Settings settings) {
        super(settings);
    }
    ...
    public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> gets(SlotReference slotContext, ItemStack stack) {
        ...
        linkedHashMultimap.put(EntityAttributes.ATTACK_DAMAGE, new EntityAttributeModifier(Identifier.of("base_attack_damage" + this.getTranslationKey()), 1, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
