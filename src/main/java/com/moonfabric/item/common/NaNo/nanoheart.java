...
public class nanoheart extends doom {
    ...
    public nanoheart(Settings settings) {
        super(settings);
    }
    ...
    public void onUnequip(ItemStack stack, SlotReference reference) {
        reference.entity().getAttributes().removeModifiers(Modifiers(reference.entity()));
    }
    ...
    public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> Modifiers(LivingEntity entity)
    {
        ...
        modifierMultimap.put(EntityAttributes.ATTACK_DAMAGE,new EntityAttributeModifier(Identifier.of(String.valueOf(this.getTranslationKey())),10, EntityAttributeModifier.Operation.ADD_VALUE));
        modifierMultimap.put(EntityAttributes.MOVEMENT_SPEED,new EntityAttributeModifier(Identifier.of(String.valueOf(this.getTranslationKey())),-0.4, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        modifierMultimap.put(EntityAttributes.MAX_HEALTH,new EntityAttributeModifier(Identifier.of(String.valueOf(this.getTranslationKey())),20, EntityAttributeModifier.Operation.ADD_VALUE));
