...
public class  quadriceps extends TheNecoraIC {
    ...
    public quadriceps(Settings settings) {
        super(settings);
    }
    ...
    public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier>  aaa(PlayerEntity player , ItemStack stack){
       Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> linkedHashMultimap = HashMultimap.create();
        linkedHashMultimap.put(EntityAttributes.MOVEMENT_SPEED, new EntityAttributeModifier(Identifier.of("base_attack_damage"+this.getTranslationKey()), 0.25, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        linkedHashMultimap.put(EntityAttributes.SAFE_FALL_DISTANCE, new EntityAttributeModifier(Identifier.of("base_attack_damage"+this.getTranslationKey()),3, EntityAttributeModifier.Operation.ADD_VALUE));
