...
public class fissionreactor extends doom {
    ...
    public fissionreactor(Settings settings) {
        super(settings);
    }
  ...
  @Override
    ...
    public void onUnequip(ItemStack stack, SlotReference reference) {
        reference.entity().getAttributes().removeModifiers(getMap(stack));
    ...
    public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> getMap(ItemStack stack) {
        ...
        a /=2;//50
        a /= 100;//0.5
            modifierMultimap.put(EntityAttributes.MOVEMENT_SPEED, new EntityAttributeModifier(Identifier.of(String.valueOf(this.getTranslationKey())),-a/2, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
        modifierMultimap.put(EntityAttributes.MAX_HEALTH, new EntityAttributeModifier(Identifier.of(String.valueOf(this.getTranslationKey())),-a, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
